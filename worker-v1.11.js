...
function centralUpgrade() {
  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      .translated-train__art{position:relative;z-index:1;min-width:0;min-height:0;width:100%;height:100%;object-fit:cover;object-position:center 18%;filter:saturate(1.12) contrast(1.06);mask-image:linear-gradient(90deg,#000 0 72%,transparent 100%);-webkit-mask-image:linear-gradient(90deg,#000 0 72%,transparent 100%)}
