...
(() => {
  ...
  const EVENT_COPY = {
    fr:[
      ...
      ["Train d’alliance · VIP","Préparer le Gold Express et répartir les places équitablement.","Pendant les 4 h de préparation, donne les contrats. Cinq rafraîchissements, soit 25 contrats, permettent de viser le Gold Express.","Le planning conserve 4 Conducteurs R4/R5 et 3 R3 choisis principalement selon les meilleurs classements, sans rotation forcée. Un même R3 peut être repris la semaine suivante s’il reste parmi les meilleurs.","N’ajoute aucun doublon dans le même planning et ne change pas le conducteur sans vérifier le planning.","Contrats commerciaux, planning Train GoMo et liste VIP."],
    ...
    pt:[
      ...
      ["Comboio da aliança · VIP","Preparar o Gold Express e repartir os lugares.","Durante as 4 h de preparação, doa contratos. Cinco atualizações, ou 25 contratos, permitem procurar o Gold Express.","O planeamento mantém 4 Condutores R4/R5 e 3 R3 escolhidos principalmente pelas melhores classificações, sem rotação forçada. O mesmo R3 pode voltar a ser escolhido na semana seguinte se continuar entre os melhores.","Evita duplicados no mesmo planeamento e não mudes o condutor sem o consultar.","Contratos comerciais, planeamento do Comboio GoMo e lista VIP."],
    ...
    en:[
      ...
      ["Alliance Train · VIP","Prepare Gold Express and share seats fairly.","During the 4-hour preparation, donate contracts. Five refreshes, or 25 contracts, can target Gold Express.","The plan keeps 4 R4/R5 Conductors and 3 R3s selected mainly from the best rankings, with no forced rotation. The same R3 may be selected again the following week while remaining among the best.","Prevent duplicates within the same plan and do not change the conductor without checking the schedule.","Trade contracts, GoMo Train schedule and VIP list."],
